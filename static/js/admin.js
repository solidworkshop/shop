...
async function startIntervals(){ await apiPost('/admin/automation/start'); setTimeout(refreshAll, 300) }
async function stopIntervals(){ await apiPost('/admin/automation/stop'); setTimeout(refreshAll, 300) }
